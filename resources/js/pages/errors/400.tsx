    ...
    <>
      ...
      <div className="min-h-screen bg-[var(--color-bg-base)] flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-6xl font-bold text-[var(--color-on-surface)] font-[var(--font-display)] mb-2">400</h1>
          <p className="text-xl text-[var(--color-on-surface-variant)] mb-1">Bad request</p>
          <p className="text-sm text-[var(--color-outline)] mb-8">
            The request could not be processed. Please go back and try again.
          </p>
