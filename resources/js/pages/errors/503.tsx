    ...
    <>
      ...
      <div className="min-h-screen bg-[var(--color-bg-base)] flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-6xl font-bold text-[var(--color-on-surface)] font-[var(--font-display)] mb-2">503</h1>
          <p className="text-xl text-[var(--color-on-surface-variant)] mb-1">Service unavailable</p>
